...
public abstract record PostDtoForManipulation
{
    ...
    [MaxLength(200,ErrorMessage = "Title can contain max 200 characters")]
    ...
    [MaxLength(1500,ErrorMessage = "Content can contain max 1500 characters")]
    ...
    [MaxLength(300,ErrorMessage = "Sec Title can contain max 300 characters")]
